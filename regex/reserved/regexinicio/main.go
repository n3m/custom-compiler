...
//StartsWithInicio ...
func (r *RegexInicio) StartsWithInicio(str string, lineIndex int64) bool {
...
func (r *RegexInicio) LogError(lineIndex int64, columnIndex interface{}, err string, description string, currentLine string) {
